...
#define EMBER_AF_PLUGIN_ZLL_COMMISSIONING_COMMON_RADIO_TX_POWER 10  // = TX_POWER_DBM (app_config.h); component slated for GUI removal (M0 leftover) but keep consistent while it builds
