...
#define SL_ZIGBEE_APP_FRAMEWORK_STAY_AWAKE_WHEN_NOT_JOINED   0  // F4/acceptance #1: a fresh (unjoined) device MUST sleep; 1 would pin EM1 forever when not joined (zigbee_app_framework_sleep.c:313-333)
